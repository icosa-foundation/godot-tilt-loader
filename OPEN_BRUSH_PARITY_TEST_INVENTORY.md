...
| `Tests/GDScript/FlatGeometryBrushParityTest.gd` | `generated mesh parity` | Flat distance/stretch geometry branches, distance/stretch atlas UV formulas, and tail trimming finalization behavior. | Does not cover every branch or reference fixture shape. |

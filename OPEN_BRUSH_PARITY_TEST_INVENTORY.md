...
| `Tests/GDScript/FlatGeometryBrushParityTest.gd` | `generated mesh parity` | Flat distance/stretch geometry branches, distance/stretch atlas UV formulas, UV1 offset vector output, non-M11 smoothing/shared-vertex output, continuation tangent generation, double-back break behavior, and tail trimming finalization behavior. | Does not cover every branch or reference fixture shape. |

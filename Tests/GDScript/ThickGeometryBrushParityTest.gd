...
func _check_distance_uv_geometry() -> void:
	...
	_expect_vec3_close(brush.m_geometry.m_Normals[ThickGeometryBrush.BRT], Vector3.FORWARD, "thick back top normal")
	_expect_vec3_close(brush.m_geometry.m_Normals[ThickGeometryBrush.BRB], -Vector3.FORWARD, "thick back bottom normal")
	...
	_expect_close(brush.m_geometry.m_Tangents[0].w, -1.0, "thick tangent handedness")

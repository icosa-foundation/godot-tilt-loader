...
func _check_distance_uv_double_sided_geometry() -> void:
	...
	_expect_vec3_close(brush.m_geometry.m_Normals[0], Vector3.FORWARD, "flat front normal")
	_expect_vec3_close(brush.m_geometry.m_Normals[1], -Vector3.FORWARD, "flat backface normal")

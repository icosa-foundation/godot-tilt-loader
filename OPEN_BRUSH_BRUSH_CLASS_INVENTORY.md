...
| `SprayBrush.gd` | `SprayBrush.cs` | `Spray`. | Spray particle quads, salt wraparound, preview decay. | Particle finalization must preserve Open Brush lifecycle semantics. | `SprayBrushParityTest.gd`, full Open Brush fixture corpus. | Partially audited; focused lifecycle coverage and all four live Spray fixtures pass reference mesh comparison. |
| `GeniusParticlesBrush.gd` | `GeniusParticlesBrush.cs` | `GeniusParticle`. | Genius particle quads, atlas UVs, randomized alpha/offset/roll, Godot particle-shader attribute export. | Must run particle finalization, remove the hanging particle, and export generated mesh attributes in the same shape as imported particle meshes. | `GeniusParticlesBrushParityTest.gd`, `MeshDataArrayExportParityTest.gd`, cafe Stars fixture replay, full Open Brush fixture corpus. | Partially audited; focused lifecycle/render-array coverage and all seven live GeniusParticle fixtures pass reference mesh and particle-render-record comparison. |
| `MidpointPlusLifetimeSprayBrush.gd` | `MidpointPlusLifetimeSprayBrush.cs` | `MiddpointPlusLifetimeGeomSpray`. | Midpoint lifetime particle geometry, UV0/UV1/tangent/color output, birth time in UV1.w. | Must preserve generated midpoint particles and avoid Genius-specific finalization behavior. | `MidpointSprayBrushParityTest.gd`, full Open Brush fixture corpus. | Partially audited; focused lifecycle coverage and all three live midpoint spray fixtures pass reference mesh comparison. |

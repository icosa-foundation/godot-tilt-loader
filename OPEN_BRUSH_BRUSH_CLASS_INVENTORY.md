...
| `FlatGeometryBrush.gd` | `FlatGeometryBrush.cs` | `FlatDistance`, `FlatStretch`, `MidpointPlusOffset`. | Flat ribbon geometry, distance/stretch UV, optional offset in texcoord1. | Batched finalization trims short post-break tails like Open Brush. | `FlatGeometryBrushParityTest.gd`, cafe DuctTapeGeometry fixture replay. | Partially audited; distance/stretch atlas branches now use the descriptor texture-atlas count directly like Open Brush and have focused coverage. |

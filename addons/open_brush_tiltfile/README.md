# Open Brush Tilt File (Godot C# Addon)

Godot-friendly package for reading and writing Open Brush / Tilt Brush `.tilt` files.

## Overview

This addon contains the core file format implementation for `.tilt` files, adapted for Godot C# projects.
...
- The addon lives under `addons/open_brush_tiltfile/`.
- Enable the addon in Project Settings if you want it listed in the Godot addon browser.
- This addon uses `unsafe` blocks; enable unsafe code in your C# project settings.
- Logging defaults to `NullLogger`. You can opt into Godot logging:

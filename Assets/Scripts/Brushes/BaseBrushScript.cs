...
namespace TiltBrush
{
	...
	public abstract partial class BaseBrushScript : MonoBehaviour
	{
		...
		{
			{ "3D Printing Brush", typeof(Square3DPrintBrush) },
			{ "BlocksBasic", typeof(BlocksBrushScript) },
			{ "BlocksGem", typeof(BlocksBrushScript) },
			{ "BlocksGlass", typeof(BlocksBrushScript) },
			{ "BubbleWand", typeof(TubeBrush) },
			{ "Bubbles", typeof(GeniusParticlesBrush) },
			{ "CelVinyl", typeof(QuadStripBrushStretchUV) },
			{ "Charcoal", typeof(QuadStripBrushDistanceUV) },
			{ "ChromaticWave", typeof(TubeBrush) },
			{ "CoarseBristles", typeof(SprayBrush) },
			{ "Comet", typeof(TubeBrush) },
			{ "ConcaveHull", typeof(ConcaveHullBrush) },
			{ "DanceFloor", typeof(MidpointPlusLifetimeSprayBrush) },
			{ "DiamondHull", typeof(HullBrush) },
			{ "Digital", typeof(QuadStripBrushDistanceUV) },
			{ "Disco", typeof(TubeBrush) },
			{ "DotMarker", typeof(SprayBrush) },
			{ "Dots", typeof(GeniusParticlesBrush) },
			{ "DoubleFlat", typeof(QuadStripBrushStretchUV) },
			{ "DoubleTaperedFlat", typeof(FlatGeometryBrush) },
			{ "DoubleTaperedMarker", typeof(FlatGeometryBrush) },
			{ "Drafting", typeof(QuadStripBrushStretchUV) },
			{ "DryBrush", typeof(QuadStripBrushStretchUV) },
			{ "DuctTape", typeof(QuadStripBrushDistanceUV) },
			{ "DuctTapeGeometry", typeof(FlatGeometryBrush) },
			{ "Electricity", typeof(FlatGeometryBrush) },
			{ "Embers", typeof(GeniusParticlesBrush) },
			{ "EnvironmentDiffuse", typeof(EnvironmentBrushScript) },
			{ "EnvironmentDiffuseLightMap", typeof(EnvironmentBrushScript) },
			{ "FacetedTube", typeof(TubeBrush) },
			{ "Fairy", typeof(QuadStripBrushDistanceUV) },
			{ "Feather", typeof(QuadStripBrushStretchUV) },
			{ "Fire", typeof(QuadStripBrushStretchUV) },
			{ "Fire2", typeof(QuadStripBrushStretchUV) },
			{ "Flat", typeof(QuadStripBrushDistanceUV) },
			{ "Flat Geometry", typeof(FlatGeometryBrush) },
			{ "FlatDeprecated", typeof(QuadStripBrushDistanceUV) },
			{ "Gouache", typeof(QuadStripBrushStretchUV) },
			...
			{ "InkGeometry", typeof(FlatGeometryBrush) },
			{ "KeijiroTube", typeof(TubeBrush) },
			{ "Lacewing", typeof(QuadStripBrushDistanceUV) },
			{ "LeakyPen", typeof(QuadStripBrushDistanceUV) },
			{ "Leaves", typeof(SprayBrush) },
			{ "Leaves2", typeof(SprayBrush) },
			{ "Light", typeof(QuadStripBrushStretchUV) },
			{ "LightWire", typeof(TubeBrush) },
			{ "Lofted", typeof(TubeBrush) },
			{ "Lofted (Hue Shift)", typeof(TubeBrush) },
			{ "Marbled Rainbow", typeof(QuadStripBrushDistanceUV) },
			{ "Marker", typeof(QuadStripBrushDistanceUV) },
			{ "Marker Geometry", typeof(FlatGeometryBrush) },
			{ "MatteHull", typeof(HullBrush) },
			{ "Muscle", typeof(TubeBrush) },
			{ "MylarTube", typeof(TubeBrush) },
			{ "NeonPulse", typeof(TubeBrush) },
			{ "Oil Paint (Geometry)", typeof(FlatGeometryBrush) },
			{ "OilPaint", typeof(QuadStripBrushStretchUV) },
			{ "Paper", typeof(QuadStripBrushDistanceUV) },
			{ "PaperGeo", typeof(FlatGeometryBrush) },
			{ "PassthroughHull", typeof(HullBrush) },
			{ "PbrTemplate", typeof(PbrBrushScript) },
			{ "PbrTransparentTemplate", typeof(PbrBrushScript) },
			{ "Petal", typeof(TubeBrush) },
			{ "Plasma", typeof(QuadStripBrushDistanceUV) },
			{ "Race", typeof(QuadStripBrushDistanceUV) },
			{ "Rain", typeof(TubeBrush) },
			{ "Rainbow", typeof(QuadStripBrushDistanceUV) },
			{ "Rising Bubbles", typeof(GeniusParticlesBrush) },
			{ "ShinyHull", typeof(HullBrush) },
			{ "SingleSided", typeof(QuadStripBrushStretchUV) },
			{ "Slice", typeof(SliceBrush) },
			{ "Smoke", typeof(GeniusParticlesBrush) },
			{ "SmoothHull", typeof(HullBrush) },
			{ "Snow", typeof(GeniusParticlesBrush) },
			{ "SoftHighlighter", typeof(QuadStripBrushStretchUV) },
			{ "Space", typeof(QuadStripBrushDistanceUV) },
			{ "Sparks", typeof(TubeBrush) },
			...
			{ "SvgTemplate", typeof(SvgBrushScript) },
			{ "Taffy", typeof(QuadStripBrushStretchUV) },
			{ "TaperedFlat", typeof(QuadStripBrushStretchUV) },
			{ "TaperedHueShift", typeof(QuadStripBrushStretchUV) },
			{ "TaperedMarker", typeof(QuadStripBrushStretchUV) },
			{ "TaperedMarkerGeo", typeof(FlatGeometryBrush) },
			{ "TaperedMarker_Flat", typeof(FlatGeometryBrush) },
			{ "TaperedWire", typeof(TubeBrush) },
			{ "ThickGeometry", typeof(ThickGeometryBrush) },
			{ "ThickPaint", typeof(QuadStripBrushDistanceUV) },
			{ "Toon", typeof(TubeBrush) },
			{ "TubeAdditive", typeof(TubeBrush) },
			{ "TubeToonInverted", typeof(TubeBrush) },
			{ "UnlitHull", typeof(HullBrush) },
			{ "VelvetInk", typeof(QuadStripBrushStretchUV) },
			{ "Watercolor Paper", typeof(QuadStripBrushDistanceUV) },
			{ "WatercolorPaperGeo", typeof(FlatGeometryBrush) },
			{ "Waveform", typeof(QuadStripBrushStretchUV) },
			{ "WaveformFFT", typeof(QuadStripBrushStretchUV) },
			{ "WaveformParticles", typeof(MidpointPlusLifetimeSprayBrush) },
			{ "WaveformTube", typeof(TubeBrush) },
			{ "WetPaint", typeof(QuadStripBrushStretchUV) },
			{ "WetPaintGeo", typeof(FlatGeometryBrush) },
			{ "WigglyGraphite", typeof(QuadStripBrushDistanceUV) },
			{ "Wind", typeof(QuadStripBrushDistanceUV) },
			{ "Wire", typeof(TubeBrush) },
			{ "Wire (Lit)", typeof(TubeBrush) },
		};
		...
		// to ensure they're set after Godot initialization
			...
			brushScript.AddChild(meshInstance);

			// Wrap in GameObject
			var prefab = new GameObject(brushScript);
